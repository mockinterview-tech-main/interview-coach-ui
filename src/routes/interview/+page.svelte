...
<div>
	...
	<div class="transcript">
		...
		{:else if !interviewConfirmed && !selectedTopic}
			...
			<p>
				Most soft skill interviews focus on one of the following topics. To practice a specific
				question like "Tell me about yourself." choose Specific Topic:
			</p>
		...
		{:else if !interviewConfirmed}
			...
			{#if !$userStore.subscriptionID}
				<p style="text-align: center;">
					Once you begin the interview session one token will be deducted.
				</p>
			{/if}
