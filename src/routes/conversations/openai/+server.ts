...
export const POST = async ({request}) => {
    ...
    const motivation: ChatCompletionSystemMessageParam = {
        ...
        When you have asked all questions up to the limit of ${questionCount || 1} and have no more follow up questions and the conversation is over, thank the candidate and end your last sentence with "${VITE_EXCHANGE_END_CODE}".
